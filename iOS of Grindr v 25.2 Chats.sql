/*Grindr for iOS v25.2 as of 4/24/25
updates profile and chat entity. DB updated to contain more data in SQL rather than Realm DB in v24.x*/
...
ORDER BY
    CASE
        WHEN ZCHATMESSAGEENTITY.ZSENDERID IS NOT NULL THEN 0
        ELSE 1
    END,
